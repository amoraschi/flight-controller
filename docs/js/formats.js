...
const FIELD_DEFS = [
    ...
    { name: 'StackWatermarkStateMachine', type: 'uint16' },
    { name: 'StackWatermarkSDProducer',   type: 'uint16' },
    { name: 'StackWatermarkSDWriter',     type: 'uint16' },
    { name: 'StackWatermarkTelemetry',    type: 'uint16' },
