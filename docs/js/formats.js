...
const FIELD_DEFS = [
    ...
    { name: 'StackUsageStateMachine', type: 'uint8' },
    { name: 'StackUsageSDProducer',  type: 'uint8' },
    { name: 'StackUsageSDWriter',    type: 'uint8' },
    { name: 'StackUsageTelemetry',   type: 'uint8' },
    { name: 'HeapFreeBytes',    type: 'uint32' },
    { name: 'HeapMinFreeBytes', type: 'uint32' },
    { name: 'SDQueueDepth',     type: 'uint8' },
    { name: 'CommandQueueDepth', type: 'uint8' },
    { name: 'BMP581ErrorCount',    type: 'uint16' },
    { name: 'IIM42653ErrorCount',  type: 'uint16' },
    { name: 'IIS2MDCTRErrorCount', type: 'uint16' },
    { name: 'BMP581StaleTicks',    type: 'uint16' },
    { name: 'IIM42653StaleTicks',  type: 'uint16' },
    { name: 'IIS2MDCTRStaleTicks', type: 'uint16' },
    { name: 'SDDroppedCount',      type: 'uint32' },
    { name: 'LastCommandType',     type: 'uint8' },
    { name: 'LastCommandTick',     type: 'uint32' },
